<?php
/*
  Template Name: Service - Custom Roof Trusses
  Omega Truss Systems — Custom Roof Trusses (copy deck dev V1, secciones 3–8)
...
$svc = array(
    ...
    'title'   => 'Custom Roof Trusses, Engineered For The Architecture.',
    'sub'     => "Vaulted geometries. Long spans. Hillside lots. Fire zones. If the roof design is ambitious, the truss system behind it has to be exact.",
    'cta'     => 'Request Engineering Review of Your Plans',
    'risk'    => "On a custom home, the roof system is where architectural intent meets structural reality. Get it wrong and you inherit failed inspections, field modifications and change orders that ripple through every trade above and below. Omega engineers each roof system to the plans, to the code and to the site, before a single member is cut.",
    'included' => array(
      'Engineered-to-order roof truss design',
      'Complex geometry: vaults, scissors, coffers, long spans',
      'Site-specific load engineering (hillside, coastal, seismic, fire zone)',
      'Sealed, code-compliant drawings for plan check',
      'In-house fabrication and installation',
      'Inspection support through sign-off',
    ),
    'why'     => "Most fabricators build what they're sent. We engineer what the project actually needs. With founder-led structural engineering and a 100% in-house process, complex roofs that other shops decline are the projects we're built for.",
    'steps'   => array('Plan review and engineering', '3D modeling and shop drawings', 'Fabrication with internal QC', 'Scheduled delivery', 'Installation by our crews', 'Inspection support'),
    'faqs'    => array(
      array('Can you match a complex architectural roof design?', "Yes. Complex geometry is our core work: vaulted, scissor and coffered systems, long spans and mixed-pitch roofs engineered to the architect's intent."),
      array('Do your drawings go through plan check?', 'We deliver fully detailed, code-compliant truss drawings prepared for California plan check, and we handle revisions in-house if the reviewer flags anything.'),
      array('Do you engineer for fire zones and coastal conditions?', "Yes. We engineer to the site's real conditions, including wildfire-designated zones, coastal exposure and hillside loads."),
      array('Who installs the roof trusses?', 'Our own installation crews. The team that engineered and fabricated your system is the team standing under it on site.'),
    ),
    'closing' => "Send us the plans. We'll tell you what the roof really needs.",
...
if (!$hero_img) {
  $hero_img = home_url('/wp-content/uploads/2026/08/CustomRoofTrusses-scaled.jpg'); // imagen del servicio (Media Library); la Featured Image la sobreescribe
}
?>
